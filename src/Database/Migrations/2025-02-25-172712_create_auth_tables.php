...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'mobile'           => ['type' => 'varchar', 'constraint' => 255],
            ...
            'tfa_secret'       => ['type' => 'varchar', 'constraint' => 32, 'null' => true],
            'tfa_method'       => ['type' => 'ENUM', 'constraint' => ['authenticator','email','sms'], 'default' => 'authenticator', 'null' => true],
            'tfa_15_mins'      => ['type' => 'varchar', 'constraint' => 6, 'null' => true],
            'tfa_15_mins_exp'  => ['type' => 'datetime', 'null' => true],
